        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('finance') }}">
              <span class="menu-title">Accounts and Finance </span>
          ...
          <li class="nav-item sidebar-actions">
            <span class="nav-link">
              <div class="border-bottom">
                <h6 class="font-weight-normal mb-3">Page Managements</h6>
              </div>
              <a href="{{ route('about-mgmt') }}"><button class="btn btn-block btn-lg btn-gradient-primary mt-4">About Us</button></a>
              <button class="btn btn-block btn-lg btn-gradient-primary mt-4">GeoLocation</button>
              <button class="btn btn-block btn-lg btn-gradient-primary mt-4">Contact Us</button>
              <button class="btn btn-block btn-lg btn-gradient-primary mt-4">Other Pages</button>
